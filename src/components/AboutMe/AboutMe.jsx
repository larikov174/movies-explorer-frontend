      ...
      <div className="about-me__columns">
        <div className="about-me__column">
          ...
          <p className="about-me__text about-me__description">
            Я родился в Воронеже, живу в Челябинске, закончил факультет экономики и финансов ЮУрГУ. У меня есть жена, двое
            детей и собака. Люблю поиграть на гитаре, люблю покататься на беговых лыжах зимой или на роликах летом.
